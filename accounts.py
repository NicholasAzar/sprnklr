...
class Accounts(object):
    ...
    def add_linked_account(self, sprnklr_id:str, tpy_user_id:str, tpy_acc_type:AccountType, alloc_percentage:float, active_flg:bool):
        self.store.add_linked_account(sprnklr_id, tpy_user_id, tpy_acc_type, alloc_percentage, active_flg)
